...
<head>
    ...
    <title>Register - ATHREE Catering</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-8">
        <div class="max-w-md w-full">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 mt-2">Buat akun customer baru</p>
            </div>
            ...
            <div class="bg-black/50 border border-gray-800 rounded-xl p-8 backdrop-blur-sm">
                ...
                <form method="POST" action="{{ route('register.submit') }}">
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-300 mb-2 text-sm">Nama Lengkap *</label>
                        <input type="text" name="nama" value="{{ old('nama') }}"
                            class="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-gray-500 transition"
                            required>
                    </div>
                    ...
                    <div class="mb-6">
                        <label class="block text-gray-300 mb-2 text-sm">Konfirmasi Password *</label>
                ...
                <p class="text-center text-gray-500 mt-6 text-sm">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="text-white hover:underline">Login di sini</a>
                </p>
            </div>
        </div>
    </div>
